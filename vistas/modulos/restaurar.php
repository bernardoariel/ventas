...
define("BACKUP_FILE", $_POST['dia'].'.sql.gz'); // Script will autodetect if backup file is gzipped based on .gz extension
define("CHARSET", 'utf8');
...
?>
  ...
  <section class="content-header">
    ...
    <h1>
        ...
        RESTAURAR BASE DE DATOS <?php echo strtoupper($_POST['dia']); ?>
...
if (php_sapi_name() != "cli") {
  ...
  $tabla = array('backup','caja','categorias','clientes','condicioniva','datostitular','empresa','modificacion_precios','nrocomprobante','pagos','parametros','precios','productos','presupuesto','stock','tipocliente','usuarios','vales','ventas');
          ...
          for($i=0; $i<$longitud; $i++){
            ...
            $respuesta = ControladorEnlace::ctrColocarIdBd($tabla[$i]);
            $respuesta2 = ControladorEnlace::ctrColocarAutoincrementBd($tabla[$i]);
    ...
    <div class="box box-danger">
      ...
      <div class="box-body">
        ...
        <div class="col-lg-8">
           ...
           <select name="dia" id="dia" class="form-control  input-lg">
        ...
        <div class="col-lg-4">
            <button type="submit" class="btn btn-danger form-control btn-block">Restaurar</button>
        </div>
