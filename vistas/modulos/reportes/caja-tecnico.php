              ...
              if($categorias["movimiento"]=="SI"){
                  ...
                  if ($stock['codigo']==302){
                    ...
                    $tablaCobrada = $tablaCobrada . '<tr>
                        ...
                        <td>'.$cantidadSericiosTerceros.'</td>
                        <td>'.$fecha.'</td>
                        <td>'.$nrofc.'</td>
                        <td>'.$cliente.'</td>
                        <td>'.$detalle.'</td>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          ...
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-text">MI TRABAJO</span>
              <span class="info-box-number"><center>$ <?php if(isset($_GET["fechaInicial"])){ echo $serviciosTerceros; }else{ echo "0.00"; } ?></center></span>
              <span class="info-box-number"> <center><small><?php if(isset($_GET["fechaInicial"])){ echo $cantidadSericiosTerceros; }else{ echo "0"; }?> Uni.</small></center></span>
